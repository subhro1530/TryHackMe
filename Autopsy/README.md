...
%TEMPDIR%=C:\Users\H4S4N\AppData\Local\Temp
%SCREENWIDTH%=1828
%SCREENHEIGHT%=974
%REGOWNER%=H4S4N
%REGORGANIZATION%=
...
%JULIANDATE%=2459253
%ISODATE%=2021-02-07
%EUROPEANDATE%=07/02/21
%FONTDIR%=C:\Windows\Fonts
%DESKTOP%=C:\Users\H4S4N\Desktop
%DESKTOPNT%=C:\Users\Public\Desktop
%STARTMENU%=C:\Users\H4S4N\AppData\Roaming\Microsoft\Windows\Start Menu
%STARTMENUNT%=C:\ProgramData\Microsoft\Windows\Start Menu
%STARTMENUPROGRAMS%=C:\Users\H4S4N\AppData\Roaming\Microsoft\Windows\Start Menu\Programs
%STARTMENUPROGRAMSNT%=C:\ProgramData\Microsoft\Windows\Start Menu\Programs
%STARTUP%=C:\Users\H4S4N\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup
%STARTUPNT%=C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp
%COMMONFILES%=C:\Program Files (x86)\Common Files
%PROGRAMFILES%=C:\Program Files (x86)
%MYDOCUMENTSDIR%=C:\Users\H4S4N\Documents
%DAOPATH%=C:\Program Files (x86)\Common Files\Microsoft Shared\DAO
%BDEPATH%=C:\idapi
%SYSTEMRAM%=2048
%MOUSEPRESENT%=TRUE
%SOUNDCARDPRESENT%=TRUE
%SETUPCMDLINEARGS%=
%SRCFILE%=C:\Users\H4S4N\Downloads\lalsetup250.exe
%SRCDIR%=C:\Users\H4S4N\Downloads
%SRCDRV%=C:
%APPDIR%=C:\Program Files (x86)\Look@LAN
%APPDRV%=C:
%SCFOLDERTITLE%=Look@LAN
%SCFOLDERPATH%=C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Look@LAN
%PRODUCTNAME%=Look@LAN
%PRODUCTVER%=2.50 Build 35
%PRODUCTTAGLINE%=World's Smart Network Monitor
...
%USERNAME%=H4S4N
%USERCOMPANY%=ThattiVidu AtiiVidu
```